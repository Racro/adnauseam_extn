...
const adnauseam = (function () {
  ...
  */
  ...
  const saveVaultImages = function (jsonName) {
    ...
    //     // 👇 save ads to JSON immediately
    //     fetch('http://127.0.0.1:5000/collect-ads', {
    //       method: 'POST',
    //       headers: {
    ...
    //     .then(res => {
    //       if (res.ok) {
    //         console.log('✅ Ads sent to server successfully!');
    //       } else {
    //         console.error('❌ Failed to send ads. Status:', res.status);
    //       }
    //     })
    //     .catch(err => {
    //       console.error('🚨 Network error sending ads:', err);
    //     });
